...
VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) {
...
private:
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f), time * 0.05f * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    void createGraphicsPipeline() {
        ...
        colorBlending.logicOpEnable     = VK_LOGIC_OP_COPY; // Optional
...
//        transitionImageLayout(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, mipLevels);
    ...
    void createColorResources() {
        ...
        createImage(swapChainExtent.width, swapChainExtent.height, 1, msaaSamples, colorFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, colorImage, colorImageMemory);
...
int main() {
    ...
    // Change default relative path to working directory
    std::string project_dir = "/Users/kiri/Documents/VulkanTutorial/VulkanTutorial/";
    if (chdir(project_dir.c_str()) == -1) {
